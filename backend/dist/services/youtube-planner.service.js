...
function researchQuestionsFor(normalized, angle) {
...
function planYoutubeProduction(input) {
    const normalizedTopic = (0, youtube_topic_normalizer_service_1.normalizeYoutubeIdea)(input.topic, input.objective);

...
export async function mockApi(page: Page, overrides: Record<string, Override> = {}): Promise<void> {
  await page.route('**/api/v1/**', async (route) => {
    ...
    if (path === '/api/v1/assets' || path === '/api/v1/projects' || path === '/api/v1/kits' || path === '/api/v1/account/api-keys' || path === '/api/v1/account/plans' || path === '/api/v1/influencer/influencers' || path === '/api/v1/influencer/products' || path === '/api/v1/influencer/projects') {
